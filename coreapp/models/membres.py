...
from coreapp.core.CONST_DATA import SEX_CHOICES, ETATCIVIL_CHOICES
...
class Membres(models.Model):
    ...
    familles = models.ManyToManyField("Familles",related_name="mes_familles", null=True)
    associations = models.ManyToManyField("Associations", null=True, blank=True)
    images = models.ManyToManyField("Images", null=True, blank=True)
    galeries = models.ManyToManyField("Galeries", related_name="mes_galeries", null=True, blank=True)
