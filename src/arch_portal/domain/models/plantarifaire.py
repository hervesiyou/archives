...
class Plan(models.Model):
    ...
    nbpublicites = models.CharField( max_length=10, blank=True, default = 0 )
    nbprestataires = models.CharField( max_length=10, blank=True, default = 0 )
    ...
    nbassociations = models.CharField(max_length=10, blank=True, default = 0 )    
