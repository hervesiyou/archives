...
class Famille(models.Model):
    ...
    famille_mere = models.ForeignKey("Famille",on_delete=models.SET_NULL, related_name="familles_enfant", null=True, blank=True)
    image = models.ForeignKey("Image",on_delete=models.SET_NULL, null=True, blank=True)
    communaute = models.ForeignKey("Communaute",on_delete=models.SET_NULL,related_name="familles_com", null=True, blank=True)
